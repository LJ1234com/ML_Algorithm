...
if __name__ == '__main__':
    ...
    dataArr, LabelArr = loadDataSet('horseColicTraining.txt')   # 加载训练集
    weakClassArr, aggClassEst = adaBoostTrainDS(dataArr, LabelArr, 40)  #AdaBoost算法形成
    testArr, testLabelArr = loadDataSet('horseColicTest.txt')   # 加载测集
    # print(weakClassArr)
